...
# Create Venues
# Vietnam Ho Chi Minh
venue_hochiminh = Venue.create({
  name: 'Ho Chi Minh',
  full_address: '148 Huynh Van Banh Phuong 10 Quan Phu Nhuan',
  region: Region.find_by(name: 'Ho Chi Minh')
})

# Venue Ha Noi
venue_hanoi = Venue.create({
  name: 'Ha Noi',
  full_address: '232 Ba Dinh Ha Noi',
  region: Region.find_by(name: 'Ha Noi')
})

#Venue Ca Mau
venue_camau = Venue.create({
  name: 'Ca Mau',
  full_address: '297 Ca Mau',
